...
-- Criando a PK de cada tabela

-- Criação da chave primária da tabela "lojas"
ALTER TABLE lojas 
ADD CONSTRAINT pk_lojas 
PRIMARY KEY (loja_id);

-- Criação da chave primária da tabela "clientes"
ALTER TABLE clientes 
ADD CONSTRAINT pk_clientes 
PRIMARY KEY (cliente_id);

-- Criação da chave primária da tabela "produtos"
ALTER TABLE produtos 
ADD CONSTRAINT pk_produtos_id 
PRIMARY KEY (produto_id);

-- Criação da chave primária da tabela "pedidos"
ALTER TABLE pedidos 
ADD CONSTRAINT pk_pedidos 
PRIMARY KEY (pedido_id);

-- Criação da chave primária da tabela "pedidos_itens"
ALTER TABLE pedidos_itens
ADD CONSTRAINT pk_pedidos_itens
PRIMARY KEY (item_id);

-- Criação da chave primária da tabela "envios"
ALTER TABLE envios
ADD CONSTRAINT pk_envios
PRIMARY KEY (envio_id);

-- Criação da chave primária da tabela "estoques"
